...
namespace LinqExtensions.Operators
{
  /// <summary>
  ...
  public static class Arithmetic
  {
    ...
    {
      Utilities.ValidateIsNumeric<T>(nameof(Add));
      Utilities.ValidateIsNotNull(leftSequence, nameof(leftSequence));
      Utilities.ValidateIsNotNull(rightSequence, nameof(rightSequence));
    ...
    {
      Utilities.ValidateIsNumeric<T>(nameof(Subtract));
      Utilities.ValidateIsNotNull(leftSequence, nameof(leftSequence));
      Utilities.ValidateIsNotNull(rightSequence, nameof(rightSequence));
    ...
    {
      Utilities.ValidateIsNumeric<T>(nameof(Multiply));
      Utilities.ValidateIsNotNull(leftSequence, nameof(leftSequence));
      Utilities.ValidateIsNotNull(rightSequence, nameof(rightSequence));
    ...
    {
      Utilities.ValidateIsNumeric<T>(nameof(Divide));
      Utilities.ValidateIsNotNull(leftSequence, nameof(leftSequence));
      Utilities.ValidateIsNotNull(rightSequence, nameof(rightSequence));
    ...
    public static IEnumerable<TResult> ApplyFunction<TSource, TResult>(this IEnumerable<IEnumerable<TSource>> sources, Func<TSource, TSource, TResult> func)
    {
      ...
      Utilities.ValidateIsNotNull(func, nameof(func));
    ...
    {
      Utilities.ValidateEnumeratedParamIsNotNull(sources, 3, nameof(sources));
      Utilities.ValidateIsNotNull(func, nameof(func));
    ...
    {
      Utilities.ValidateEnumeratedParamIsNotNull(sources, 4, "sources");
      Utilities.ValidateIsNotNull(func, nameof(func));
    ...
    {
      Utilities.ValidateEnumeratedParamIsNotNull(sources, 5, "sources");
      Utilities.ValidateIsNotNull(func, nameof(func));
    ...
    {
      Utilities.ValidateEnumeratedParamIsNotNull(sources, 6, "sources");
      Utilities.ValidateIsNotNull(func, nameof(func));
    ...
    {
      Utilities.ValidateEnumeratedParamIsNotNull(sources, 7, "sources");
      Utilities.ValidateIsNotNull(func, nameof(func));
    ...
    {
      Utilities.ValidateEnumeratedParamIsNotNull(sources, 8, "sources");
      Utilities.ValidateIsNotNull(func, nameof(func));
    ...
    {
      Utilities.ValidateEnumeratedParamIsNotNull(sources, 9, "sources");
      Utilities.ValidateIsNotNull(func, nameof(func));
    ...
    {
      Utilities.ValidateEnumeratedParamIsNotNull(sources, 10, "sources");
      Utilities.ValidateIsNotNull(func, nameof(func));
    ...
    {
      Utilities.ValidateEnumeratedParamIsNotNull(sources, 11, "sources");
      Utilities.ValidateIsNotNull(func, nameof(func));
    ...
    {
      Utilities.ValidateEnumeratedParamIsNotNull(sources, 12, "sources");
      Utilities.ValidateIsNotNull(func, nameof(func));
    ...
    {
      Utilities.ValidateEnumeratedParamIsNotNull(sources, 13, "sources");
      Utilities.ValidateIsNotNull(func, nameof(func));
    ...
    {
      Utilities.ValidateEnumeratedParamIsNotNull(sources, 14, "sources");
      Utilities.ValidateIsNotNull(func, nameof(func));
    ...
    {
      Utilities.ValidateEnumeratedParamIsNotNull(sources, 15, "sources");
      Utilities.ValidateIsNotNull(func, nameof(func));
    ...
    {
      Utilities.ValidateEnumeratedParamIsNotNull(sources, 16, "sources");
      Utilities.ValidateIsNotNull(func, nameof(func));
