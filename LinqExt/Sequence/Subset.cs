...
namespace LinqExtensions.Sequence
{
  ...
  public static class Subset
  {
    ...
    /// <exception cref="System.ArgumentNullException">source is null</exception>
    /// <exception cref="System.ArgumentException">take and skip must be larger than 0</exception>
    ...
    public static IEnumerable<TSource> TakePattern<TSource>(this IEnumerable<TSource> source, int initialSkip, int take, int skip)
    {
      Utilities.ValidateIsNotNull(source, nameof(source));
      if (take < 1)
        throw Exceptions.InvalidTakeCount("take");
      if (skip < 1)
        throw Exceptions .InvalidSkipCount("skip");
    ...
    {
      return TakeBefore(source, item, EqualityComparer<TSource>.Default);
    }
    ...
    {
      return TakeSelfAndBefore(source, item, EqualityComparer<TSource>.Default);
    }
    ...
    {
      return TakeAfter(source, item, EqualityComparer<TSource>.Default);
    }
    ...
    {
      return TakeAfter(source, item, count, EqualityComparer<TSource>.Default);
    }
    ...
    {
      return TakeSelfAndAfter(source, item, EqualityComparer<TSource>.Default);
    }
    ...
    {
      return TakeSelfAndAfter(source, item, count, EqualityComparer<TSource>.Default);
    }
