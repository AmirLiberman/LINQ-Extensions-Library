...
namespace LinqExtensions.Sequence
{
  ...
  public static class Analysis
  {
    ...
    {
      return SequenceRelation(source, other, EqualityComparer<TSource>.Default);
    }
    ...
    {
      return source.GetPattern(EqualityComparer<T>.Default, 1, int.MaxValue, false);
    }
    ...
    {
      return source.GetPattern(EqualityComparer<T>.Default, minSize, maxSize, exactFit);
    }
    ...
    {
      return IndexOf(source, item, EqualityComparer<T>.Default, startIndex);
    }
