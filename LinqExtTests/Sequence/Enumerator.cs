...
namespace LinqExtTests.Sequence
{
  ...
  public class EnumeratorTests
  {
    ...
    public void SequenceGeneratorTest10()
    {
      ...
      catch (InvalidOperationException e) { Assert.IsTrue(e.Message == "Generate cannot be applied to 'Boolean'."); }
    ...
    public void RangeTest3()
    {
      ...
      catch (InvalidOperationException e) { Assert.IsTrue(e.Message == "Range cannot be applied to 'Boolean'."); }
      catch (Exception) { Assert.Fail(); }
    }
