...
namespace LinqExtensions.Array
{
  /// <summary>
  ...
  public static class ArrayExtensions
  {
    ...
    public static IEnumerable<T[]> Slice<T>(this T[,] source)
    {
      ...
      Utilities.ValidateIsPremitive<T>(nameof(Slice));
    ...
    {
      Utilities.ValidateIsNotNull(source, nameof(source));
      Utilities.ValidateIsPremitive<T>(nameof(Fuse));
    ...
    public static IEnumerable<T[]> CircularShift<T>(this T[] source, int x, int xStep)
    {
      ...
      Utilities.ValidateValueIsInRange(x, 1, xLen, "x");
      Utilities.ValidateValueIsInRange(xStep, 1, xLen, "xStep");
    ...
    public static IEnumerable<T[,]> CircularShift<T>(this T[,] source, int y, int x, int yStep, int xStep)
    {
      ...
      Utilities.ValidateValueIsInRange(x, 1, xLen, "x");
      Utilities.ValidateValueIsInRange(y, 1, yLen, "y");
      Utilities.ValidateValueIsInRange(xStep, 1, xLen, "xStep");
      Utilities.ValidateValueIsInRange(yStep, 1, yLen, "yStep");
    ...
    public static IEnumerable<T[,,]> CircularShift<T>(this T[,,] source, int z, int y, int x, int zStep, int yStep, int xStep)
    {
      ...
      Utilities.ValidateValueIsInRange(x, 1, xLen, "x");
      Utilities.ValidateValueIsInRange(y, 1, yLen, "y");
      Utilities.ValidateValueIsInRange(z, 1, yLen, "z");
      Utilities.ValidateValueIsInRange(xStep, 1, xLen, "xStep");
      Utilities.ValidateValueIsInRange(yStep, 1, yLen, "yStep");
      Utilities.ValidateValueIsInRange(zStep, 1, zLen, "zStep");
    ...
    public static IEnumerable<T[,,,]> CircularShift<T>(this T[,,,] source, int a, int z, int y, int x, int aStep, int zStep, int yStep, int xStep)
    {
      ...
      Utilities.ValidateValueIsInRange(y, 1, yLen, "y");
      Utilities.ValidateValueIsInRange(z, 1, yLen, "z");
      Utilities.ValidateValueIsInRange(a, 1, aLen, "a");
      Utilities.ValidateValueIsInRange(xStep, 1, xLen, "xStep");
      Utilities.ValidateValueIsInRange(yStep, 1, yLen, "yStep");
      Utilities.ValidateValueIsInRange(zStep, 1, zLen, "zStep");
      Utilities.ValidateValueIsInRange(aStep, 1, aLen, "aStep");
    ...
    {
      Utilities.ValidateIsNotNull(source, nameof(source));
      Utilities.ValidateValueIsInRange(x, 1, int.MaxValue, "x");
    ...
    public static T[,] ToArray<T>(this IEnumerable<T> source, int y, int x)
    {
      Utilities.ValidateIsNotNull(source, nameof(source));
      Utilities.ValidateValueIsInRange(x, 1, int.MaxValue, "x");
      Utilities.ValidateValueIsInRange(y, 1, int.MaxValue, "y");
    ...
    public static T[,,] ToArray<T>(this IEnumerable<T> source, int z, int y, int x)
    {
      ...
      Utilities.ValidateValueIsInRange(x, 1, int.MaxValue, "x");
      Utilities.ValidateValueIsInRange(y, 1, int.MaxValue, "y");
      Utilities.ValidateValueIsInRange(z, 1, int.MaxValue, "z");
    ...
    {
      Utilities.ValidateIsNotNull(source, nameof(source));
      Utilities.ValidateValueIsInRange(x, 1, int.MaxValue, "a");
      Utilities.ValidateValueIsInRange(x, 1, int.MaxValue, "x");
      Utilities.ValidateValueIsInRange(y, 1, int.MaxValue, "y");
      Utilities.ValidateValueIsInRange(z, 1, int.MaxValue, "z");
    ...
    {
      Utilities.ValidateIsNotNull(source, nameof(source));
      Utilities.ValidateValueIsInRange(newSize, 1, int.MaxValue, "newSize");
    ...
    public static double[,,,] Resize(this double[,,,] source, int a, int z, int y, int x)
    {
      ...
      Utilities.ValidateValueIsInRange(y, 1, int.MaxValue, "y");
      Utilities.ValidateValueIsInRange(z, 1, int.MaxValue, "z");
      Utilities.ValidateValueIsInRange(a, 1, int.MaxValue, "a");
    ...
    /// <param name="subtracter">A function to use when subtracting two T elements.</param>
    ...
    /// <returns>The newly resized array.</returns>
    /// <exception cref="System.ArgumentNullException">source, adder, subtracter, multiplier or divider is null.</exception>
    /// <exception cref="System.ArgumentException">newSize is out of range.</exception>    
    public static T[] Resize<T>(this T[] source, Add<T> adder, Subtract<T> subtracter, Multiply<T> multiplier, Divide<T> divider, int newSize)
    {
      Utilities.ValidateIsNotNull(source, nameof(source));
      Utilities.ValidateIsNotNull(adder, nameof(adder));
      Utilities.ValidateIsNotNull(subtracter, nameof(subtracter));
      Utilities.ValidateIsNotNull(multiplier, nameof(multiplier));
      Utilities.ValidateIsNotNull(divider, nameof(divider));
      ...
      else if (originalSizeX < newSize) // Expand
      {
        for (int x = 0; x < newSize; x++)
        {
          ...
          {
            int rightCell = leftCell + 1;
            destArr[x] = adder(source[leftCell], multiplier(subtracter(source[rightCell], source[leftCell]), pos.FractionPart()));
          }
        }
      }
      else // Shrink
    ...
    /// <exception cref="System.ArgumentNullException">source, adder, subtracter, multiplier or divider is null.</exception>
    /// <exception cref="System.ArgumentException">x or y is out of range.</exception>        
    public static T[,] Resize<T>(this T[,] source, Add<T> adder, Subtract<T> subtracter, Multiply<T> multiplier, Divide<T> divider, int y, int x)
    {
      Utilities.ValidateIsNotNull(source, nameof(source));
      Utilities.ValidateIsNotNull(adder, nameof(adder));
      Utilities.ValidateIsNotNull(subtracter, nameof(subtracter));
      ...
      return source.Slice()
            .Select(X => X.Resize(adder, subtracter, multiplier, divider, x))
            .Fuse()
            .Rotate(270)
            .Slice()
            .Select(X => X.Resize(adder, subtracter, multiplier, divider, y))
            .Fuse()
            .Rotate(90);
    }
    ...
    /// <exception cref="System.ArgumentNullException">source, adder, subtracter, multiplier or divider is null.</exception>
    /// <exception cref="System.ArgumentException">x, y or z is out of range.</exception>    
    public static T[,,] Resize<T>(this T[,,] source, Add<T> adder, Subtract<T> subtracter, Multiply<T> multiplier, Divide<T> divider, int z, int y, int x)
    {
      Utilities.ValidateIsNotNull(source, nameof(source));
      Utilities.ValidateIsNotNull(adder, nameof(adder));
      Utilities.ValidateIsNotNull(subtracter, nameof(subtracter));
      ...
      return source.Slice()
                   .Select(X => X.Resize(adder, subtracter, multiplier, divider, y, x))
                   .Fuse()
                   .Rotate(RotateAxis.RotateY, -90)
                   .Slice()
                   .Select(X => X.Slice()
                                 .Select(X1 => X1.Resize(adder, subtracter, multiplier, divider, z))
                                 .Fuse())
                   .Fuse()
                   .Rotate(RotateAxis.RotateY, 90);
    }
    ...
    /// <exception cref="System.ArgumentNullException">source, adder, subtracter, multiplier or divider is null.</exception>    
    /// <exception cref="System.ArgumentException">x, y, z or a is out of range.</exception>    
    public static T[,,,] Resize<T>(this T[,,,] source, Add<T> adder, Subtract<T> subtracter, Multiply<T> multiplier, Divide<T> divider, int a, int z, int y, int x)
    {
      Utilities.ValidateIsNotNull(source, nameof(source));
      Utilities.ValidateIsNotNull(adder, nameof(adder));
      Utilities.ValidateIsNotNull(subtracter, nameof(subtracter));
      ...
      return source.Slice()
                   .Select(X => X.Resize(adder, subtracter, multiplier, divider, z, y, x))
                   .Fuse()
                   .Rotate(RotateAxis.RotateY, 90)
                   .Slice()
                   .Select(X => X.Slice()
                                 .Select(X1 => X1.Slice()
                                                 .Select(X3 => X3.Resize(adder, subtracter, multiplier, divider, a))
                                                 .Fuse())
                                  .Fuse())
                   .Fuse()
                   .Rotate(RotateAxis.RotateY, -90);
    ...
    {
      Utilities.ValidateIsNotNull(source, nameof(source));
      Utilities.ValidateSquareAngle(angle);
    ...
    {
      Utilities.ValidateIsNotNull(source, nameof(source));
      Utilities.Validate3DRotation(axis);
      Utilities.ValidateSquareAngle(angle);
      angle = angle % 360;
    ...
    private static T[,,] Rotate3D090<T>(this T[,,] source, RotateAxis axis)
    {
      ...
      switch (axis)
      {
        ...
        case RotateAxis.RotateZ:
          ...
          break;
        default:
          throw Exceptions.InvalidAxis(axis);
      }
    ...
    {
      Utilities.ValidateIsNotNull(source, nameof(source));
      Utilities.Validate4DRotation(axis);
      Utilities.ValidateSquareAngle(angle);
    ...
    {
      Utilities.ValidateIsNotNull(source, nameof(source));
      Utilities.ValidateIsNotNull(newSection, nameof(newSection));

      int xNewSectionLen = newSection.GetLength(0);
      int xSourceLen = source.GetLength(0);

      Utilities.ValidateValueIsInRange(offset, 0, xSourceLen - xNewSectionLen, "offset");
    ...
    public static void Replace<T>(this T[,] source, T[,] newSection, int yOffset, int xOffset)
    {
      ...
      Utilities.ValidateValueIsInRange(yOffset, 0, ySourceLen - yNewSectionLen, "yOffset");
      Utilities.ValidateValueIsInRange(xOffset, 0, xSourceLen - xNewSectionLen, "xOffset");
    ...
    public static void Replace<T>(this T[,,] source, T[,,] newSection, int zOffset, int yOffset, int xOffset)
    {
      ...
      Utilities.ValidateValueIsInRange(zOffset, 0, zSourceLen - zNewSectionLen, "zOffset");
      Utilities.ValidateValueIsInRange(yOffset, 0, ySourceLen - yNewSectionLen, "yOffset");
      Utilities.ValidateValueIsInRange(xOffset, 0, xSourceLen - xNewSectionLen, "xOffset");
    ...
    public static void Replace<T>(this T[,,,] source, T[,,,] newSection, int aOffset, int zOffset, int yOffset, int xOffset)
    {
      ...
      Utilities.ValidateValueIsInRange(aOffset, 0, aSourceLen - aNewSectionLen, "aOffset");
      Utilities.ValidateValueIsInRange(zOffset, 0, zSourceLen - zNewSectionLen, "zOffset");
      Utilities.ValidateValueIsInRange(yOffset, 0, ySourceLen - yNewSectionLen, "yOffset");
      Utilities.ValidateValueIsInRange(xOffset, 0, xSourceLen - xNewSectionLen, "xOffset");
    ...
    public static T[] Extract<T>(this T[] source, int offset, int length)
    {
      ...
      int xSourceLen = source.GetLength(0);
      Utilities.ValidateValueIsInRange(offset, 0, xSourceLen - length, "offset");
    ...
    public static T[,] Extract<T>(this T[,] source, int yOffset, int xOffset, int yLength, int xLength)
    {
      ...
      int ySourceLen = source.GetLength(0);
      int xSourceLen = source.GetLength(1);
      Utilities.ValidateValueIsInRange(yOffset, 0, ySourceLen - yLength, "yOffset");
      Utilities.ValidateValueIsInRange(xOffset, 0, xSourceLen - xLength, "xOffset");
    ...
    public static T[,,] Extract<T>(this T[,,] source, int zOffset, int yOffset, int xOffset, int zLength, int yLength, int xLength)
    {
      ...
      Utilities.ValidateValueIsInRange(zOffset, 0, zSourceLen - zLength, "zOffset");
      Utilities.ValidateValueIsInRange(yOffset, 0, ySourceLen - yLength, "yOffset");
      Utilities.ValidateValueIsInRange(xOffset, 0, xSourceLen - xLength, "xOffset");
    ...
    public static T[,,,] Extract<T>(this T[,,,] source, int aOffset, int zOffset, int yOffset, int xOffset, int aLength, int zLength, int yLength, int xLength)
    {
      ...
      Utilities.ValidateValueIsInRange(aOffset, 0, aSourceLen - aLength, "aOffset");
      Utilities.ValidateValueIsInRange(zOffset, 0, zSourceLen - zLength, "zOffset");
      Utilities.ValidateValueIsInRange(yOffset, 0, ySourceLen - yLength, "yOffset");
      Utilities.ValidateValueIsInRange(xOffset, 0, xSourceLen - xLength, "xOffset");
    ...
    {
      Utilities.ValidateIsNotNull(source, nameof(source));
      Utilities.ValidateIsNotNull(other, nameof(other));

      return source.ArrayEquals(other, EqualityComparer<object>.Default);
    }
    ...
    public static bool ArrayEquals<T>(this System.Array source, System.Array other, IEqualityComparer<T> comparer)
    {
      Utilities.ValidateIsNotNull(source, nameof(source));
      Utilities.ValidateIsNotNull(other, nameof(other));
      Utilities.ValidateIsNotNull(comparer, nameof(comparer));
    ...
    {
      Utilities.ValidateIsNotNull(array, nameof(array));
